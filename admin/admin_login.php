...
<nav class="navbar navbar-dark navbar-expand-md py-0 bg-dark">
      ...
      <div class="container-fluid">
        <a class="navbar-brand py-0" href="/DevFuse/index.php" style="font-size: 30px;font-family: Aclonica, sans-serif;">
            <img src="..\assets\logos\logo.png" alt="" height="80px" width="100px">DevFuse
        </a>
        ...
        <div class="collapse navbar-collapse" id="navcol-1">
          <ul class="nav navbar-nav ml-auto">
            <li class="nav-item"><a class="nav-link active" href="/DevFuse/index.php"
                style="padding: 8px;padding-right: 2vw;font-size: 20px;">Home</a></li>
            <li class="nav-item"><a class="nav-link active" href="/DevFuse/index.php#about_us"
                style="padding: 8px;padding-right: 2vw;font-size: 20px;">About Us</a></li>
            <li class="nav-item"><a class="nav-link active" href="/DevFuse/index.php#faq"
            ...
            <!-- Different nav bar link for new LOGIN and REGISTER modal -->
            <li class="nav-item">
    ...
    <div class="row">
        ...
        <div class="col-lg-6 loginForm">
            <div class="text-center">
                <img src="..\assets\logos\logo.png"  alt="" height="150px" width="150px;">
            </div> 
  ...
  <div class="footer-distributed pt-5 pb-2 px-0 bg-dark">
    ...
    <div class="container-fluid bg-dark px-1 text-center">
        <p class="text-white mt-2">Copyright &copy
          <?php echo date('Y'). " "; ?>DevFuse<span><a href="/DevFuse/admin/admin_login.php" class="btn btn-secondary"
